...
export const PSQI_QUES_5: object = {
  ...
  questions: [
    ...
    {
      id: 'J',
      ques: 'Other reason (s), please describe, including how often you have had trouble sleeping because of this reason (s):',
      reason: '',
      ans: null
    },
  ]
...
export const PSQI_QUES_6_9: object[] = [
  {
    id: '6',
    ques: 'During the past month, how often have you taken medicine (prescribed or “over the counter”) to help you sleep?',
    ans: null
  },
  {
    id: '7',
    ques: 'During the past month, how often have you had trouble staying awake while driving, eating meals, or engaging in social activity?',
    ans: null
  },
  {
    id: '8',
    ques: 'During the past month, how much of a problem has it been for you to keep up enthusiasm to get things done?',
    ans: null
  },
  {
    id: '9',
    ques: 'During the past month, how would you rate your sleep quality overall?',
    ans: null
  },
];
